# UAE Free Offers & Student Discounts — Database

This is the source-of-truth table. Contributors: edit **this file**, not the README (the README copy gets refreshed from here periodically). See [`../instructions/`](../instructions/) for the exact row format.
...
Offer terms, eligibility and validity change often — especially airline and retailer percentage discounts. If a link is dead or a term is stale, open a PR or Issue instead of leaving it broken for the next reader.
